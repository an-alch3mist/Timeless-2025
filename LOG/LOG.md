 * LIST<> Count: 6                             
-----------------------------------------------
 Cube (0) trigger (0) (UnityEngine.GameObject) 
 Cube (0) trigger (1) (UnityEngine.GameObject) 
 Cube (0) trigger (0) (UnityEngine.GameObject) 
 Cube (0) trigger (1) (UnityEngine.GameObject) 
 Cube (0) trigger (0) (UnityEngine.GameObject) 
 Cube (0) trigger (1) (UnityEngine.GameObject) 
 ...
 * LIST<> Count: 12                                    
-------------------------------------------------------
 Cube (0) trigger (0) inside (UnityEngine.GameObject)  
 Cube (0) trigger (1) outside (UnityEngine.GameObject) 
 Cube (0) trigger (0) inside (UnityEngine.GameObject)  
 Cube (0) trigger (1) outside (UnityEngine.GameObject) 
 Cube (0) trigger (0) inside (UnityEngine.GameObject)  
 Cube (0) trigger (1) outside (UnityEngine.GameObject) 
...
│   │ ├ [doorLockedJiggle = true] (hasExitTime:☐ | exitTime:0.75 | transition duration:0.01s) → doorLockedClosedJiggle
│   │ ├ [doorBlockedJiggle = true] (hasExitTime:☐ | exitTime:0.75 | transition duration:0.01s) → doorBlockedClosedJiggle
...
└ -> Layer 2: LAYER 2: Outside Lock (Weight: 1.0, Override Blending)
    ...
    │ └ [auto] (hasExitTime:☑ | exitTime:1.00 | transition duration:0.00s) → outsideLockedIdle
...
./doorHingedSimple (0)/(scale:1.0 | anim, asrc, SimpleDoorAnimEventForwarder, SimpleDoorHinged)
├ trigger (scale:1.0 | no components)
│ └ door auto trigger (scale:1.0 | bc, DoorAutoOpenCloseTrigger)
├ door (scale:1.0 | no components)
│ ├ frame(visual + collider) (scale:(1.0,2.0,0.1) | dmc)
│ │ ├ cube outside (scale:1.0 | dmc, bc)
│ │ └ cube inside (scale:1.0 | dmc, bc)
...
./drawerSlideSimple/(scale:1.0 | anim, asrc, SimpleDoorDrawer, SimpleDoorAnimEventForwarder)
└ frame (scale:1.0 | no components)
  ├ visual (scale:(0.5,0.5,1.0) | dmc)
  ├ collider outside (scale:(0.5,0.5,1.0) | bc)
  └ handle outside (scale:(0.1,0.1,0.0) | no components)
    └ handle visual (scale:1.0 | dmc, bc)

```

```animatorController-hierarchy
=== Animator Controller: doorOpenCloseAnimController_stateMachineApproach Simple Base ===
...
│   │ └ [isDoorOpen = true] (hasExitTime:☐ | exitTime:0.75 | transition duration:0.50s) → doorOpenedIdleAnim
│   ├ doorClosingAnim | Motion: doorClosingAnim | Speed: 1.00x
│   │ └ [auto] (hasExitTime:☑ | exitTime:1.00 | transition duration:0.00s) → doorClosedIdleAnim
│   ├ doorLockedClosedJiggle | Motion: doorLockedClosedJiggle | Speed: 1.00x
│   │ └ [auto] (hasExitTime:☑ | exitTime:1.00 | transition duration:0.01s) → doorClosedIdleAnim
│   ├ doorOpenedIdleAnim | Motion: doorOpenedIdleAnim | Speed: 1.00x
│   │ ├ [doorClose = true] (hasExitTime:☐ | exitTime:0.75 | transition duration:0.01s) → doorClosingAnim
...
│   │ └ [doorSwayStart = true] (hasExitTime:☐ | exitTime:0.75 | transition duration:0.30s) → doorSwayLoopAnim
│   ├ doorOpeningAnim | Motion: doorOpeningAnim | Speed: 1.00x
│   │ └ [auto] (hasExitTime:☑ | exitTime:1.00 | transition duration:0.00s) → doorOpenedIdleAnim
│   └ doorSwayLoopAnim | Motion: doorSwayLoopAnim | Speed: 1.00x
│     ├ [doorSwayStop = true && isDoorOpen = false] (hasExitTime:☐ | exitTime:0.50 | transition duration:0.25s) → doorClosedIdleAnim
│     └ [doorSwayStop = true && isDoorOpen = true] (hasExitTime:☐ | exitTime:0.69 | transition duration:0.20s) → doorOpenedIdleAnim
